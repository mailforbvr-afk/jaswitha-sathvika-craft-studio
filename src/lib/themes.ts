...
export const THEMES: Record<ThemeId, ThemeDefinition> = {
  "pink-dream": {
    ...
    decorations: ["🎀", "✨", "🦋", "🌸", "💕", "⭐"],
    preview: ["#f6c4d6", "#ddd0f3", "#d36b91", "#cfe8f7"],
    vars: themeVars({
      cream: "#fff7fb",
      creamDark: "#f8e4ee",
      ink: "#4a2c45",
      ...
      sun: "#ffe9a8",
      card: "#ffffff",
      cardBorder: "rgba(246, 196, 214, 0.45)",
      shadow: "0 14px 32px rgba(168, 92, 126, 0.12)",
      shadowHover: "0 18px 36px rgba(168, 92, 126, 0.16)",
      radius: "1.7rem",
      spot1: "rgba(246, 196, 214, 0.55)",
      spot2: "rgba(221, 208, 243, 0.5)",
      spot3: "rgba(207, 232, 247, 0.42)",
      spot4: "rgba(207, 238, 224, 0.35)",
      spot5: "rgba(255, 233, 168, 0.12)",
      cats: [
        "#fde3ee", "#f7cfe0",
        "#f3e7fb", "#ddd0f3",
        "#e4f4fc", "#cfe8f7",
